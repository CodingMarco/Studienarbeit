...
Ist die GeoTIFF-Datei erstellt, kann diese sehr einfach als numpy-Array eingelesen werden, was in \autoref{lst:GdalOpen} demonstriert wird.
Außerdem können die Metadaten ausgelesen werden, was in den Zeilen 6 bis 9 zu sehen ist.
...
print(geotransform)  # -> (927793.0, 4000.0, 0.0, 6313386.0, 0.0, -4000.0)
print(f"{geotiff.RasterXSize} x {geotiff.RasterYSize}") # -> 50 x 50
print(type(raster_data))  # -> <class 'numpy.ndarray'>
print(raster_data.shape)  # -> (50, 50)
\end{minted}
...
% TODO: Evtl. noch Geschwindigkeitsvergleich
