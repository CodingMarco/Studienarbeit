...
In \autoref{sec:Datensatz} wird der verwendete Datensatz in Grundzügen analysiert und anschließend so verarbeitet, dass er als Eingabe für ein \acrfull{nn} verwendet werden kann.
