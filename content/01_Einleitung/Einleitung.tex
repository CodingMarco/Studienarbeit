...
Dies ist, wie Chollet in \cite{Chollet} auf Seite 152 argumentiert, eine wichtige Annahme, derer man sich bei jeglichen Vorhersagen bewusst sein muss.
...
Die Gefahr sollte jedoch stetig steigen, je länger an einem Ort keine Radarkontrolle mehr anzutreffen war.
...
Wie in \autoref{sec:VerwanteteForschung} gezeigt wird, gibt es einige vielversprechende Ansätze, wie Neuronale Netze (\Acrshortpl{nn}) verwendet werden können, um sehr ähnliche Problemstellungen anzugehen.
