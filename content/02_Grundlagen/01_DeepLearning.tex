...
Beim Machine Learning ist es nun anders herum.
...
Das Perzeptron (auch Zelle, Neuron, Element) genannt bildet nach \cite{6S191Intro} den Grundbaustein von \acrshortpl{nn}.
...
Ein Perzeptron hat eine beliebige Anzahl von Eingängen (engl. Inputs).
...
Ein Beispiel für eine einfache Verlustfunktionen ist der mittlere quadratische Fehler (engl. \acrlong{mse}, \acrshort{mse}).
Die Berechnungsvorschrift ist in \autoref{eq:MSE} zu sehen.
