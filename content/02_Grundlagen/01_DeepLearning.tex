...
Bekannte Aktivierungsfunktionen sind z.B. \emph{Sigmoid} oder \emph{ReLU}, wobei in der Praxis meistens \emph{ReLU} verwendet wird \cite{ActivFuncSharma,ActivFuncNwankpa}.
