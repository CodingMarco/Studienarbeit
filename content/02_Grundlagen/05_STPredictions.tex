\subsection{Räumlich-zeitliche Vorhersagen}
...
Beispiele für räumlich kontinuierliche Daten wären das Auftreten von Verkehrsunfällen oder Verbrechen.
...
Liegen die Daten räumlich kontinuierlich vor, müssen zunächst Cluster gebildet werden.
Jeder diskrete Ort bzw. jeder Cluster wird dann ein Knoten des Graphs.
...
Dies könnte beispielsweise das Straßennetz sein, wenn es sich bei den Daten um Verkehrsdaten handelt.
...
Wetterstationen liefern beispielsweise meißt Messwerte in regelmäßigen Zeitabständen.
